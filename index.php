...
<?php
    /*KEXND3D2XAFXS
     Plugin Name: mobile App Banners
     Plugin URI: http://www.winyourbrand.com/wordpress-plugins/mobileappbanners
     Description: Automatically implement Safari's new mobile App Banner feature on your Wordpress site. The banner provides a standardized method of promoting apps on the App Store from any website. The banner will automatically appear on all pages. In order for this to work you have to enter your app id in <strong>Settings > mobile App Banners > Your App ID</strong>
     Version: 3.0
     Author: Wael Badawy
     Author URI: http://www.winyourbrand.com
     License: GPL2
     */
    
    
    $plugin_label = __('Mobile App Banners', 'mobile_app_banners');
    $plugin_slug = "mobile_app_banners";
    
    class mobile_app_banners {
...
<style type="text/css">
.winyourbranddonate{border: 1px solid #DADADA; background:white; font-family: tahoma,arial,helvetica,sans-serif;font-size: 12px;overflow: hidden;padding: 5px;position: absolute;right: 0;text-align: center;top: 0;width: 275px; box-shadow:0px 0px 8px rgba(153, 153, 153, 0.81);z-index:9;-webkit-transition: all .2s ease-out;  -moz-transition: all .2s ease-out;-o-transition: all .2s ease-out;transition: all .2s ease-out;}
.winyourbranddonate:hover {background:rgb(176, 249, 255);}
    .winyourbranddonate form{display:block;}
    #winyourbrand_top_banner {background: rgb(221, 215, 215);margin: -5px;margin-bottom: 7px;padding-bottom: 4px;line-height: 16px;font-size: 18px;text-indent: 6px;}
    .winyourbranddonate ul {padding-left:16px;}
    .winyourbranddonate li {list-style-type: disc;list-style-position: outside;}
    
    @media only screen and (max-width: 1300px) {
        .donly {display:none;}
        .winyourbranddonate li {list-style-type:none;}
        .winyourbranddonate *, .winyourbranddonate {width:auto !important;}
    }
    @media only screen and (max-width: 400px) {
        .winyourbranddonate {bottom: -90px;left: 0px;top: auto;right: auto;}
    }
    </style>
    <div class="winyourbranddonate">
    <div style="width: 276px; text-align: left;">
    <div id="winyourbrand_top_banner" class="donly">Ways to say thanks</div>
    ...
    <ul>
    <li><span class="donly">Donate a few dollars to my company winyourbrand to help with future development and updates.</span>
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input name="cmd" value="_s-xclick" type="hidden"><input name="hosted_button_id" value="KEXND3D2XAFXS" type="hidden"><input type="hidden" name="no_shipping" value="1"><input type="hidden" name="item_name" value="The winyourbrand Network Plugin Support - <?php echo $this->plugin_label ?>" /><input alt="PayPal - The safer, easier way to pay online!" name="submit" src="https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif" type="image"> <img src="https://www.paypal.com/en_US/i/scr/pixel.gif" alt="" border="0" height="1" width="1"></form>
    </li>
    <li class="donly">Follow me on <a href="https://twitter.com/winyourbrand" target="_blank">Twitter</a></li>
    <li class="donly">Connect with me on <a href="http://www.linkedin.com/in/winyourbrand/" target="_blank">LinkedIn</a></li>
    <li class="donly"><a href="http://wordpress.org/support/view/plugin-reviews/mobile-app-banners" target="_blank" title="Rate it">Rate it</a> on WordPress.org</li>
    <li class="donly">Blog about it & link to the <a href="http://www.winyourbrand.com/wordpress-plugins/mobile-app-banners/" target="_blank">plugin page</a></li>
    <li class="donly">Check out my other <a href="http://www.winyourbrand.com/wordpress-plugins/" target="_blank">WordPress plugins</a></li>
    <li class="donly"><a href="mailto:info@winyourbrand.com" target="_blank">Email me</a> to say thanks. If you can let me know where my plugins are being used 'in the wild' I always appreciate that.</li>
    </ul>
    <div class="donly">Thanks in advance for your support.</div>
        <div style="font-style:italic;" class="donly">-Wael Badawy</div>
        </div>
        </div>
        </div>
...
public function page_init(){
    ...
    add_settings_field(
                       ...
                       array(                                // The array of arguments to pass to the callback.
                             "id" => $field_id, //sends field id to callback
                             "desc" => __('Uncheck this box to only show mobile app banners on specific posts and pages', $this->plugin_slug), //description of the field (optional)
...
public function admin_notices() {
    ...
    if( (!(get_option($this->plugin_slug.'_'.$field_slug) ) AND (get_option($this->plugin_slug.'_on_all_pages', 1, false) == 1))  ) {
        ...
        <div class="updated">
        <p><strong>';
        printf( __( '%s is almost ready.</strong> You must <a href="%s/wp-admin/options-general.php?page=%s-setting-admin">enter your App ID</a> for it to work.', 'mobile_app_banners' ), $this->plugin_label,  get_bloginfo( 'wpurl' ), $this->plugin_slug);
        echo '</p>
        </div>';
    }
...
function app_store_download($atts) { //parameters stored in atts variable
    ...
    extract( shortcode_atts( array(
                                   'size' => 100,
                                   'verticalalign' => 'top',
                                   'id' => get_option("mobile_app_banners_your_app_id"),
    ...
    $html = "";
    $html .= "<style>";
    $html .= "img.winyourbrand_app_store_shortimage".$i." {width: ".$width."px; vertical-align: ".$verticalalign.";}";
    $html .= "</style>";
    if ( $id != '') {
        $html .= '<a  href="http://itunes.apple.com/app/id'.$id.'"><img style="box-shadow: none;" class="winyourbrand_app_store_shortimage'.$i.'" src="'.plugins_url( 'images/download_on_the_app_store.png' , __FILE__ ).'"></a>';
    }
...
function android_download($atts) { //parameters stored in atts variable
    ...
    $html = "";
    $html .= "<style>";
    $html .= "img.winyourbrand_android_store_shortimage".$a." {width: ".$width."px; vertical-align: ".$verticalalign.";}";
    $html .= "</style>";
    if ( $id != '') {
        $html .= '<a  href="http://play.google.com/store/apps/details?id='.$id.'"><img style="box-shadow: none;" class="winyourbrand_android_store_shortimage'.$a.'" src="'.plugins_url( 'images/download_for_android.png' , __FILE__ ).'"></a>';
    }
...
public function plugin_row_links($links, $file) {
    ...
    if ($file == $plugin) // only for this plugin
        return array_merge( $links,
                           array( '<a target="_blank" href="http://www.linkedin.com/in/WinYourBrand/">' . __('Find me on LinkedIn', $this->plugin_slug) . '</a>' ),
                           array( '<a target="_blank" href="http://twitter.com/WinYourBrand">' . __('Follow me on Twitter', $this->plugin_slug) . '</a>' )
                           );
    return $links;
}
...
//begin meta box
$metabox_label = __('mobile App Banners', 'mobile_app_banners');
$metabox_slug = "mobile_app_banners";
...
class mobile_app_banners_meta_box {
    function winyourbrand_meta_init()
    {
        ...
        {
            add_meta_box($this->metabox_slug.'_all_meta', $this->metabox_label, array($this, 'winyourbrand_meta_setup'), $type, 'normal', 'high');
        }
        
        // add a callback function to save any data a user enters in
        add_action('save_post',array($this, 'winyourbrand_meta_save'));
    }
    
    function winyourbrand_meta_setup()
    {
        global $post;
        ...
        ?>
        <div class="winyourbrand_meta_control">
    ...
    function winyourbrand_meta_save($post_id)
    {
        ...
        // var types
        // single: _winyourbrand_meta[var]
        // array: _winyourbrand_meta[var][]
        // grouped array: _winyourbrand_meta[var_group][0][var_1], _winyourbrand_meta[var_group][0][var_2]
        
        $current_data = get_post_meta($post_id, '_'.$this->metabox_slug, TRUE);
        
        $new_data = $_POST['_'.$this->metabox_slug];
        
        //$this->winyourbrand_meta_clean($new_data);
    ...
    /*    function winyourbrand_meta_clean(&$arr)
     {
     if (is_array($arr))
     {
     foreach ($arr as $i => $v)
     ...
     if (is_array($arr[$i]))
     {
     $this->winyourbrand_meta_clean($arr[$i]);
...
add_action('admin_init', array($metabox, 'winyourbrand_meta_init'));
...
class mobile_App_Banners_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
                            $this->slug = "mobile_app_banners_widget", // Base ID
                            $this->label = __('winyourbrand Download on the App Store', 'mobile_app_banners'), // Name
                            array( 'description' => __( 'Displays a Download on the App Store badge linking to your app', 'mobile_app_banners' ), ) // Args
                            );
        ...
        //add text
        $fields[] = array(
                          "field_title" => __('Your App ID', 'mobile_app_banners'),
                          "field_slug" => "your_app_id",
                          "field_type" => "text",
                          "default" => get_option("mobile_app_banners_your_app_id")
                          );
        
        //add text input
        $fields[] = array(
                          "field_title" => __('Badge Size (100 = Full, 50 = half...)', 'mobile_app_banners'),
                          "field_slug" => "size",
                          "field_type" => "text",
                          "default" => 100,
                          );
        ...
        //add select input
        $fields[] = array(
                          "field_title" => __('Align', 'mobile_app_banners'),
                          "field_slug" => "align",
                          "field_type" => "select",
                          "options" => array(
                                             array("title" => __('Left', 'mobile_app_banners'), "value" => "left"),
                                             array("title" => __('Center', 'mobile_app_banners'), "value" => "center"),
                                             array("title" => __('Right', 'mobile_app_banners'), "value" => "right"),
                                             ),
                          );
...
add_action( 'widgets_init', create_function( '', 'register_widget( mobile_app_banners_widget );' ) );
...
class mobile_App_Android_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
                            $this->slug = "mobile_app_android_widget", // Base ID
                            $this->label = __('winyourbrand Download for Android', 'mobile_app_banners'), // Name
                            array( 'description' => __( 'Displays a Download for Android badge linking to your app', 'mobile_app_banners' ), ) // Args
                            );
        ...
        //add text
        $fields[] = array(
                          "field_title" => __('Your Apps <a href=\'http://developer.android.com/distribute/googleplay/promote/linking.html\' target=\'_blank\'><i>Package Name</i></a>', 'mobile_app_banners'),
                          "field_slug" => "your_app_id",
                          "field_type" => "text",
                          //"default" => get_option("mobile_app_banners_your_app_id")
                          );
...
// register custom widget
add_action( 'widgets_init', create_function( '', 'register_widget( mobile_app_android_widget );' ) );
